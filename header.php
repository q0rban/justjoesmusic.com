...
<div class="row">
  <div class="col">
    ...
    ?>
    <div class='alert alert-primary center' style="margin:0;">Custom Showroom Hours Starting June 9th<br />Tuesday – Wednesday – Thursday<br />1:00-5:00<br />Or any other time happily <a href="<?php print $path_to_root; ?>contact-us">by appointment</a>.<br />Please, one family member per visit when possible.</div>
<!--    <div class="temp-link">-->
