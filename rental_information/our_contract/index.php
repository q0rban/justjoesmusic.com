    ...
    <div class="width-container">
      <div class="row">
        <div class="col eb-garamond center blue">
          <h2 class="eb-garamond mobile-heading" style="padding-top: 25px; padding-bottom: 15px; font-size: 42px;">A Little More<br />About our Contract</h2>
        </div>
      </div>
      <div class="row align-items-center">
        <div class="col-lg-6">
          <p class="muli paragraph-col align-middle esurance-font-color">
            In the middle of the rental season action, the information on the back of the contract can sometimes get 
            glossed over. Please take a moment now while you’re not battling clarinets squeaking and trumpets blasting 
            to review some of the fine print. You’ll thank us later. </p>

        </div>

        <div class="col-lg-6">
          <div class="center">
            <iframe class="youtube angle-title-left" style="max-width: 500px;" src="https://www.youtube.com/embed/1s_w7hx3n7A" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
        </div>
      </div>
      <div class="row align-items-center">
