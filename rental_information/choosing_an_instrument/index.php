      ...
      <div class="width-container">
        <div class="row">
          <div class="col eb-garamond center blue">
            <h2 class="eb-garamond mobile-heading" style="padding-top: 25px; padding-bottom: 15px; font-size: 42px;">Choosing an Instrument</h2>
          </div>
        </div>
        <div class="row align-items-center">
          <div class="col-lg-6" style="text-align:center;">
            <iframe class="youtube light-gray angle-title-right left-content align-items-center" style="max-width: 500px;" src="https://www.youtube.com/embed/CCTeSjpDsIs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
          <div class="col-lg-6">
