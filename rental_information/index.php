      ...
      <div class="width-container">
        <div class="row">
          <div class="col eb-garamond center blue">
            <h2 class="eb-garamond mobile-heading" style="padding-top: 25px; padding-bottom: 15px; font-size: 42px;">Rental Information</h2>
          </div>
        </div>
        <div class="row align-items-center">
          <div class="col-lg-6" style="text-align:center;">
          <div class="youtube">
            <iframe class="youtube light-gray angle-title-right left-content align-items-center" style="max-width: 500px;" src="https://www.youtube.com/embed/SESIGd1EhDk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
          </div>
          <div class="col-lg-6">
            <p class="muli align-middle esurance-font-color paragraph-col">
              Please take a few minutes to view our "Joe Talks Rentals" video. Hopefully it will be time well spent 
              better understanding our store and instrument rental program. Please note, this video is a few years old 
              but everything remains the same except we now require a 10 month school year commitment as opposed to 9 
              months. Thank you.
            </p>
          </div>
        </div>
