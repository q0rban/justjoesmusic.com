<?php
  $path_to_root = "../../";
  $title = "1953 Selmer SBA Alto Sax"
?>
    ...
    <div class="width-container">
      <div class="row">
        <div class="col eb-garamond center blue">
          <h2 class="eb-garamond mobile-heading" style="padding-top: 25px; padding-bottom: 15px; font-size: 42px;">1953 Selmer SBA Alto Sax</h2>
        </div>
      </div>
      <div class="row align-items-center">
        <div class="col">
          <p class="paragraph muli esurance-font-color">
            98% Original Lacquer Beauty. This one-owner 51XXX alto plays wonderfully from top to bottom. Minor lacquer wear on touch points. To me, the tone is fantastic with a nice rich, dark core and a lively upper register. The instrument was o-hauled some years back and has less than 10 hours of play time. All adjustments are solid and the horn is in top playing condition. Original Chesterfield Traypak case w/clarinet insert included. The case was always covered with the original cover and is in great condition. No previous solders, damage repair or neck pull-down.
        </div>
      </div>
      <!-- <div class="row align-items-center">
        <div class="col-lg-6">
          <img src="../../img/sba/1.jpg" style="width: 100%; padding-bottom: 10px;" />
        </div>
        <div class="col-lg-6">
          <img src="../../img/sba/2.jpg" style="width: 100%; padding-bottom: 10px;" />
        </div>
      </div>
      <div class="row align-items-center">
        <div class="col-lg-6">
      ...
      <div class="row align-items-center">
        <div class="col">
          <img src="<?php echo $S3_BUCKET; ?>img/sba/1.jpg" style="width: 100%; padding-bottom: 10px;" />
        </div>
      </div>
      <div class="row align-items-center">
        <div class="col">
          <img src="<?php echo $S3_BUCKET; ?>img/sba/2.jpg" style="width: 100%; padding-bottom: 10px;" />
        </div>
      </div>
      <div class="row align-items-center">
        <div class="col">
          <img src="<?php echo $S3_BUCKET; ?>img/sba/3.jpg" style="width: 100%; padding-bottom: 10px;" />
        </div>
      </div>
      <div class="row align-items-center">
        <div class="col">
          <img src="<?php echo $S3_BUCKET; ?>img/sba/4.jpg" style="width: 100%; padding-bottom: 10px;" />
        </div>
      </div>
      <div class="row align-items-center">
        <div class="col">
          <img src="<?php echo $S3_BUCKET; ?>img/sba/5.jpg" style="width: 100%; padding-bottom: 10px;" />
        </div>
      </div>
