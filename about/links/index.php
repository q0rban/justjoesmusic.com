...
<body>
    ...
    <div class="width-container">
      <div class="row">
        <div class="col eb-garamond center blue">
          <h2 class="eb-garamond mobile-heading" style="padding-top: 25px; font-size: 42px;">Community Links</h2>
        </div>
      </div>
      <div class="row center align-items-middle muli esurance-font-color links">
        <div class="col align-items-middle">
          <a href="http://bendinstrumentrepair.com" target="_blank"><img src="<?php echo $S3_BUCKET; ?>img/links/bir.png" class="vertical-center" style="padding: 20px 30px 0 30px !important;" /></a>
        </div>
        <div class="col align-items-middle">
          <a href="https://www.bendpops.org/" target="_blank"><img src="<?php echo $S3_BUCKET; ?>img/links/coco.png" class="vertical-center" style="width: 200px; padding: 20px 30px 0 30px !important;" /></a>
        </div>
        <div class="col">
          <a href="http://www.centraloregonyouthorchestra.org/" target="_blank"><img src="<?php echo $S3_BUCKET; ?>img/links/coyo.jpg" class="vertical-center" style="padding: 20px 30px 0 30px !important;" /></a>
        </div>
      </div>
      <div class="row center align-items-middle muli esurance-font-color links">
      </div>
      <div class="row center align-items-middle muli esurance-font-color links">
        <div class="col">
          <a href="http://www.cascadehorizonband.org/" target="_blank"><img src="<?php echo $S3_BUCKET; ?>img/links/horizon.png" class="vertical-center" /></a>
        </div>
        <div class="col">
          <a href="http://notablesswingband.com/?id=home" target="_blank"><img src="<?php echo $S3_BUCKET; ?>img/links/notables.gif" class="vertical-center" /></a>
        </div>
        <div class="col align-items-middle">
          <a href="http://www.ccschoolofmusic.org/" target="_blank"><img src="<?php echo $S3_BUCKET; ?>img/links/csm.png" class="vertical-center" /></a>
        </div>
      </div>
      <div class="row center align-items-middle muli esurance-font-color links" style="padding-bottom: 20px;">
        <div class="col">
          <a href="https://www.cosymphony.com/" target="_blank"><img src="<?php echo $S3_BUCKET; ?>img/links/cosymphony.jpg" style="width: 150px;" class="vertical-center" /></a>
        </div>
        <div class="col">
          <a href="http://cascadewinds.org/" target="_blank"><img src="<?php echo $S3_BUCKET; ?>img/links/cascadewinds.png" style="width: 150px;" class="vertical-center" /></a>
        </div>
      </div>
    </div>
  </div>
  <div id="mainPageinlineContent-gridContainer" data-mesh-internal="true">
    ...
    <div data-packed="true" style="width: 192px; pointer-events: none; margin-bottom:10px;" class="txtNew no-mobile" id="WRchTxt1f-p9o">
