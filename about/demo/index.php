    ...
    <div class="width-container">
      <div class="row">
        <div class="col eb-garamond center blue">
          <h2 class="eb-garamond mobile-heading" style="padding-top: 25px; padding-bottom: 15px; font-size: 42px;">Demo</h2>
        </div>
      </div>
      <div class="row align-items-center">
        <div class="col-lg-6">
          <p class="paragraph-col muli esurance-font-color">
            Thanks again for the interest in my music.<br /><br />

            In addition to performing solo (recordings below) I also work in a duo, quartet and quintet.<br /><br />

            Please <a href="../../contact_us/">contact us</a> for quote and availability.<br /><br />

            Joe<br />
            (541) 977-5637 (JOES)
          </p>
          <p class="muli esurance-font-color" style="padding-bottom: 0; margin-bottom: 0;">
            Corcovado
          </p>
          <audio controls>
            <source src="<?php echo $S3_BUCKET; ?>img/demo/corcovado.mp3" type="audio/mpeg">
          ...
          <audio controls>
            <source src="<?php echo $S3_BUCKET; ?>img/demo/body_and_soul.mp3" type="audio/mpeg">
            Your browser does not support the audio element.
          </audio>
          <p class="muli esurance-font-color" style="padding-bottom: 0; margin-bottom: 0;">
            Fools Rush In
          ...
          <audio controls>
            <source src="<?php echo $S3_BUCKET; ?>img/demo/fools_rush_in.mp3" type="audio/mpeg">
            Your browser does not support the audio element.
          </audio>

        </div>
        <div class="col-lg-6 center">
          <img src="<?php echo $S3_BUCKET; ?>img/demo/joe.png" class="angle-title-left" style="width: 50%; max-width: 500px;" />
        </div>
      </div>
    </div>
  </div>
