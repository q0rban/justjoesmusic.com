    ...
    <div class="width-container">
      <div class="row">
        <div class="col eb-garamond center blue">
          <h2 class="eb-garamond mobile-heading" style="padding-top: 25px; padding-bottom: 15px; font-size: 42px;">Private Teachers</h2>
        </div>
      </div>
      <div class="row align-items-center muli esurance-font-color">
        <div class="col center">
          <h3>Please Contact Store</h3>
          <h4 style="padding-bottom: 20px;">(541) 318-5646</h4>
        </div>
      </div>
    </div>
  </div>
