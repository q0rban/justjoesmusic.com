    ...
    <div class="width-container">
      <div class="row">
        <div class="col eb-garamond center blue">
          <h2 class="eb-garamond mobile-heading" style="padding-top: 25px; padding-bottom: 15px; font-size: 42px;">Do We Buy?</h2>
        </div>
      </div>
      <div class="row align-items-center">
        <div class="col">
          <p class="paragraph muli esurance-font-color">
            We no longer take in instruments on consignment. Additionally, we rarely purchase used instruments. However, if you would like to <a href="mailto: joe@justjoesmusic.com">email us</a> what you have, we're happy to take a look.<br /><br />
            ...
            -Condition on a scale from 1 to 10<br />

            -Pictures if possible<br /><br />

            If we have an interest we will be sure to email you.<br /><br />
