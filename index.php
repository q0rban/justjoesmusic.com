    ...
    <div class="row">
      <div class="col eb-garamond center blue">
        <div class="width-container">
          <h2 class="eb-garamond mobile-heading" style="padding-top: 25px; padding-bottom: 15px; font-size: 42px;">Welcome to Just Joe's</h2>
        </div>
        <div class="">
          <div class="width-container">
            <p class="muli paragraph" style="font-size:18px; margin-bottom: 0;"><span style="font-size:18px; "><span style="color:#555;"><span>
                    Thank you for taking the time to visit my web site. I am proud to be a part of Central Oregon's
                    Musical Community. For the past 23 years, I have provided friendly and
                    caring assistance for our area's students and performers. "Just Joe's Music"
                    has been and will remain dedicated to offering only the highest possible quality
                    products and service.<br>
                    <br>
                    As a rental, step-up and professional instrument specialist, I stand behind every aspect of what I
                    do. I own all of my rentals. I have done the shopping for you by selecting playable,
                    affordable and durable instruments that I will service for you right here.
                    I look forward to helping you and your student's experience
                    in music.<br><br>Sincerely,<br>
                    Joe Rohrbacher</span></span></span><br>
              &nbsp;</p>
          </div>
        </div>
      </div>
