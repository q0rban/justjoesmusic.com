    ...
    <div class="width-container">
      <div class="row">
        <div class="col eb-garamond center blue">
          <h2 class="eb-garamond mobile-heading" style="padding-top: 25px; padding-bottom: 15px; font-size: 42px;">Contact Us</h2>
        </div>
      </div>
      <div class="row align-items-center">
        <div class="col center esurance-font-color muli">
          <h3>Just Joe's Music</h3>
          <p>
            61400 S Hwy 97 #3<br />
            Bend, OR 97702<br />
          </p>
          <p>
            <small>Direct to Store</small><br />
            541-318-5646<br />
            <small>Joe's Cell</small><br />
            541-977-5637
          </p>
          <p>
            E-mail me:<br />
      ...
      <div class="row align-items-center">
        <div class="col" style="">
          <div style="padding: 0 20px 0 20px;">
            <form class="muli esurance-font-color background-esurance" id="contactForm" style="padding: 10px 10px 10px 10px !important; max-width: 600px; margin: 0 auto; margin-bottom: 20px;" action="../php/contact_form.php" method="POST">
